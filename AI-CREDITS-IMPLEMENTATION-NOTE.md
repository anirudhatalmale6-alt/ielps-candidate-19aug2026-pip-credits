...
4. Confirmation that the hold-then-settle shape above is the behaviour wanted,
   rather than a simpler charge-on-success model that risks a creator starting
   work they cannot pay for.

Items 1–3 are commercial values and are not mine to choose. Item 4 is a design
decision I would like confirmed before writing the migration.
